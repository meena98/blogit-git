...
class ArticleViewSet(mixins.CreateModelMixin,mixins.ListModelMixin,mixins.RetrieveModelMixin,viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        ...
        favourited_by=self.request.query_params.get('favorited',None)
        if favourited_by is not None:
            queryset=queryset.filter(favourited_by__user__username=favourited_by)
...
# page=serializer_instances
    ...
    def retrieve(self, request,slug):
        ...
        try:
            ...
            raise NotFound("an article with the slug doesnt exist")
    ...
    def update(self,request,slug):
        ...
        try:
            ...
            raise NotFound("an article with the slug wasnt found")
...
class CommentsListCreateAPIView(generics.ListCreateAPIView):
    ...
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = Comment.objects.select_related('article','article__author','article__author__user',
                'author','author__user')
    ...
    def create(self, request, article_slug=None):
        ...
        try:
            ...
            raise NotFound("comments for article with the slug wasnt found")
...
class CommentsDestroyAPIView(generics.DestroyAPIView):
    ...
    def destroy(self, request, article_slug=None,comment_pk=None):
        try:
            ...
            raise NotFound("the comment with the id wasnt found")

        comment.delete()

        return Response(None,status=status.HTTP_204_NO_CONTENT)

class ArticlesFavouriteAPIView(APIView):
    ...
    def delete(self,request,article_slug=None):
        ...
        try:
            ...
            raise NotFound("the article with the slug was not found")
